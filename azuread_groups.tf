...
module "azuread_groups" {
  source   = "git::https://github.com/sep/terraform-azurerm-caf.git//modules/azuread/groups"
...
module "azuread_groups_members" {
  source   = "git::https://github.com/sep/terraform-azurerm-caf.git//modules/azuread/groups_members"
  for_each = local.azuread.azuread_groups
